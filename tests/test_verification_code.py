...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "ZK9QWE4471820365994172T en la sede electronica",
            "ZK9QWE4471820365994172T",
        ),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "Fdo.:______ ZK9QWE4471820365994172T",
    ],
)
...
def test_a_confirmed_code_is_caught_again_where_context_is_missing():
    ...
    text = (
        ...
        "ZK9QWE4471820365994172T en la sede. "
        "Firma del interesado, Fdo.:_________ ZK9QWE4471820365994172T"
    )
    assert _codes(text) == [
        "ZK9QWE4471820365994172T",
        "ZK9QWE4471820365994172T",
...
def test_propagation_does_not_invent_codes_of_its_own():
    ...
    text = (
        "Codigo Seguro de Verificacion ZK9QWE4471820365994172T. "
        "Referencia catastral 5189011DF2958H0001KE."
    )
    assert _codes(text) == ["ZK9QWE4471820365994172T"]
